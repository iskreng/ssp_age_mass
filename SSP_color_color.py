...
select_0p005Z=((ssp_model_0p005Z['log_age_yr']>=lg_age_limit) & (ssp_model_0p005Z['log_age_yr']<=lg_age_up_limit))
select_0p02Z=((ssp_model_0p02Z['log_age_yr']>=lg_age_limit) & (ssp_model_0p005Z['log_age_yr']<=lg_age_up_limit))
select_0p04Z=((ssp_model_0p04Z['log_age_yr']>=lg_age_limit) & (ssp_model_0p005Z['log_age_yr']<=lg_age_up_limit))
select_0p2Z=((ssp_model_0p2Z['log_age_yr']>=lg_age_limit) & (ssp_model_0p005Z['log_age_yr']<=lg_age_up_limit))
select_Z=((ssp_model_Z['log_age_yr']>=lg_age_limit) & (ssp_model_0p005Z['log_age_yr']<=lg_age_up_limit))
select_2p5Z=((ssp_model_2p5Z['log_age_yr']>=lg_age_limit) & (ssp_model_0p005Z['log_age_yr']<=lg_age_up_limit))
...
ssp_model_0p005Z=ssp_model_0p005Z[(ssp_model_0p005Z['log_age_yr']>=lg_age_limit) & (ssp_model_0p005Z['log_age_yr']<=lg_age_up_limit)]
ssp_model_0p02Z=ssp_model_0p02Z[(ssp_model_0p02Z['log_age_yr']>=lg_age_limit) & (ssp_model_0p02Z['log_age_yr']<=lg_age_up_limit)]
ssp_model_0p04Z=ssp_model_0p04Z[(ssp_model_0p04Z['log_age_yr']>=lg_age_limit) & (ssp_model_0p04Z['log_age_yr']<=lg_age_up_limit)]
ssp_model_0p2Z=ssp_model_0p2Z[(ssp_model_0p2Z['log_age_yr']>=lg_age_limit) & (ssp_model_0p2Z['log_age_yr']<=lg_age_up_limit)]
ssp_model_Z=ssp_model_Z[(ssp_model_Z['log_age_yr']>=lg_age_limit) & (ssp_model_Z['log_age_yr']<=lg_age_up_limit)]
ssp_model_2p5Z=ssp_model_2p5Z[(ssp_model_2p5Z['log_age_yr']>=lg_age_limit) & (ssp_model_2p5Z['log_age_yr']<=lg_age_up_limit)]
...
if example==True:
    ...
    parser.add_argument("--example",type=bool)
    parser.add_argument("--m606",type=float)
    parser.add_argument("--m606_err",type=float)
    parser.add_argument("--m814",type=float)
    parser.add_argument("--m814_err",type=float)
    parser.add_argument("--m160",type=float)
    parser.add_argument("--m160_err",type=float)
...
for row in data_phot.itertuples():
    if example==True:
        ...
        index,ee,ff,aa,bb,cc,dd,gg=row; print(row)
        data=pd.DataFrame({'f606w' : [aa],\
                       'f606w_err' : [bb],\
                       'f814w' : [cc],\
                       'f814w_err' : [dd],\
...
#        ax1.plot(m814m160_14Gyr,m606m814_14Gyr,linestyle='--',color='gray',zorder=0)
        ...
        #ax1.plot(ssp_model_0p02Z['606m160'],ssp_model_0p02Z['606m814'], color='lightblue', linestyle='-', label='0.02Z$_\odot$',zorder=0)
...
#            temp.replace(axis=0,inplace=True,to_replace=[np.nan,np.inf,-np.inf],value=-1e1)
            ...
            max_ml=ssp_model[likelihood_column_name].max() ; data[max_ml_name]=max_ml

            # Maximum likelihood weighted age, m_to_l and mass
            if example==True:
                ml_age=ssp_model['log_age_yr'][(ssp_model[likelihood_column_name]==max_ml)].values[0]
            else:
            ...
            if example==True:
                ml_m_to_l=ssp_model['M_star_tot_to_Lv'][ssp_model[likelihood_column_name]==max_ml].values[0]
            else:
    ...
    if example==True:
        ...
        ax22.plot(1e-9*10**(ssp_model_0p04Z['log_age_yr']),np.exp(ssp_model_0p04Z['ml_mod0p04Z']),linestyle='-',color='blue',label='0.04Z$_\odot$')
        ax22.set_xlim(1.,15); ax22.set_xticks(np.arange(2,16,2))#; ax22.yaxis.set_visible(False)
        ax22.vlines(1e-9*10**(ssp_model_0p04Z['log_age_yr'][ssp_model_0p04Z['ml_mod0p04Z']==ssp_model_0p04Z['ml_mod0p04Z'].max()]),\
                   np.exp(ssp_model_0p04Z['ml_mod0p04Z'].min()),np.exp(data['max_ml_0p04Z'].max()),linestyle='-', colors='gray', zorder=2, label='')
        ...
        ax33.plot(1e-9*10**(ssp_model_Z['log_age_yr']),np.exp(ssp_model_Z['ml_modZ']),linestyle='-',color='red',label='Z$_\odot$')
        ax33.vlines(1e-9*10**(ssp_model_Z['log_age_yr'][ssp_model_Z['ml_modZ']==ssp_model_Z['ml_modZ'].max()]),\
                   np.exp(ssp_model_Z['ml_modZ'].min()),np.exp(data['max_ml_Z'].max()),linestyle='-', colors='gray', zorder=2, label='')
        ...
        ax44.set_xlabel("Age [Gyr]")
        ax44.set_xlim(1.,15); ax44.set_xticks(np.arange(2,16,2))
        ...
        ax44.plot(1e-9*10**(ssp_model_0p005Z['log_age_yr']),np.exp(ssp_model_0p005Z['ml_mod0p005Z']),linestyle='-',color='darkblue',label='0.005Z$_\odot$')
#        ax44.yaxis.set_visible(False)
        ...
        ax4.set_xlim(1.,15); ax4.set_xticks(np.arange(2,16,2))
        ax4.plot(1e-9*10**(ssp_model_0p02Z['log_age_yr']),np.e**(ssp_model_0p02Z['ml_mod0p02Z']),color='lightblue',linestyle='-',label='0.02Z$_\odot$')
        ax4.vlines(1e-9*10**(ssp_model_0p02Z['log_age_yr'][ssp_model_0p02Z['ml_mod0p02Z']==ssp_model_0p02Z['ml_mod0p02Z'].max()]),np.exp(ssp_model_0p02Z['ml_mod0p02Z'].min()),np.exp(data['max_ml_0p02Z'].max()),linestyle='-', colors='gray',label='')
